...
<script data-cfasync="false" type="text/javascript"
        src="${pageContext.request.contextPath}/javascript/FormSubmit.js"></script>
...
<div class="container-contact100">
	<div class="wrap-contact100">
		<form class="gform" method="post"
		      action="https://script.google.com/macros/s/AKfycbw-B0D4lkeVpJETQJNchMUvrrKhhuGFHecOFnbZWho5Vn7fCIU/exec">
			...
			<div style="display:none; text-align: center;" class="thankyou_message">
				<p style="font-size: 1.5em; color: #d1cc6e;"><em>Thanks</em> for contacting us! We will get back to you
					soon!</p>
			</div>
		</form>
	</div>
