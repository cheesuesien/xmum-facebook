...
<head>
    ...
    <link rel="stylesheet" type="text/css"  href='styles/carouFredSel.css' />
    <link rel="stylesheet" type="text/css"  href='styles/sm-clean.css' />
...
<div class="content-1170 header-holder center-relative">
    <div class="header-logo left">
        <a href="testing.jsp">
            <img src="../img/katt_default_logo.png" alt="Katt">
        </a>
    </div>
    ...
    <div class="blog-holder block center-relative">
                ...
                <div class="image-slider-wrapper">
                    <div class="caroufredsel_wrapper">
                        <ul id="slider1" class="image-slider slides center-text">
                            <li><img src="../img/katt_home_image01_slider01.jpg" alt=""></li>
                            <li><img src="../img/katt_home_image01_slider02.jpg" alt=""></li>
                            <li><img src="../img/katt_home_image01_slider03.jpg" alt=""></li>
                        </ul>
                    </div>
        ...
        <article id="post-3" class="relative blog-item-holder">
            <div class="post-thumb thumb-image two_third_thumb left">
                <img src="../img/katt_home_image02.jpg" alt="">
            </div>
        ...
        <article id="post-4" class="relative blog-item-holder">
            <div class="post-thumb thumb-image two_third_thumb right">
                <img src="../img/katt_home_image03.jpg" alt="">
            </div>
        ...
        <article id="post-5" class="relative blog-item-holder">
            <div class="post-thumb thumb-image one_third_thumb left">
                <img src="../img/katt_home_image04.jpg" alt="">
            </div>
        ...
        <article id="post-7" class="relative blog-item-holder">
            <div class="post-thumb thumb-image two_third_thumb right">
                <img src="../img/katt_home_image05.jpg" alt="">
            </div>
            <div class="post-title-holder one_third_title left">
    ...
    <div class="content-1170 center-relative">
        <ul>
            ...
            <li class="center-footer-content">
                <a href="testing.jsp">
                    <img src="../img/katt_default_footer_logo.png" alt="Katt">
                </a>
            </li>
...
<div class="fixed scroll-top">
    <img src="../img/back_to_top.png" alt="Go Top">
</div>


<script type="text/javascript" src="../javascript/jquery.js"></script>
<script type="text/javascript" src="../javascript/jquery.smartmenus.min.js"></script>
<script type="text/javascript" src="../javascript/queryloader2.min.js"></script>
<script type="text/javascript" src="../javascript/jquery.carouFredSel-6.0.0-packed.js"></script>
